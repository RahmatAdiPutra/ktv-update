...
use App\Http\Requests\Web\MasterData\RoomTypeRequest;
...
class RoomTypeController extends Controller
{
    ...
    {
        // return $this->seed(10);
        return view('master-data.room-type.index');
    }
    ...
    public function post(RoomTypeRequest $request)
    {
        try {
            if ($request->id) {
    ...
    {
        $type->delete();
        return $this->responseSuccess(['message' => 'Room Type has been deleted']);
    }
}
